  ...
  <div class="accordion" role="tablist">
        ...
        <b-card-body class="m-0 p-0">
          <router-link to="/site_info">
            <b-card-text class="m-0 p-2">
              <span
                  v-bind:class="[ routePath == '/' || routePath == '/site_info' ? classObject : '' ]">로고/언어/사이트명 설정</span>
            </b-card-text>
          </router-link>
          <hr class="m-0 p-0"/>
    ...
    <b-card no-body class="mb-0 p-0">
      <router-link to="/mainmenu">
        <b-card-header class="p-0" role="tab">
          <b-button block squared v-b-toggle.accordion-2 variant="info" size="sm" class="text-left"
                    v-bind:class="[ routePath.includes('/mainmenu') ? active_parent_menu : '' ]">
    ...
    <b-card no-body class="mb-0 p-0">
      <b-card-header class="p-0" role="tab">
        <b-button block squared v-b-toggle.accordion-3 variant="info" size="sm" class="text-left"
                  v-bind:class="[ routePath == '/company/list' || routePath == '/company/regist' || routePath == '/company/admin' || routePath == '/com_request' ? active_parent_menu : '' ]">
          <span>3. 기업정보관리</span>
        </b-button>
      </b-card-header>
    ...
    <b-card no-body class="mb-0 p-0">
      <router-link to="/user_list">
        <b-card-header class="p-0" role="tab">
          <b-button block squared v-b-toggle.accordion-4 variant="info" size="sm" class="text-left"
                    v-bind:class="[ routePath == '/user_list' ? active_parent_menu : '' ]">
            <span>4. 계정관리</span>
          </b-button>
        </b-card-header>
      </router-link>
    ...
    <b-card no-body class="mb-0 p-0">
      <b-card-header class="p-0" role="tab">
        <b-button block squared v-b-toggle.accordion-5 variant="info" size="sm" class="text-left"
                  v-bind:class="[ routePath == '/vm' || routePath == '/conference_notice' ? active_parent_menu : '' ]">
      ...
      <b-collapse id="accordion-5" visible accordion="inowing-accordion" role="tabpanel" v-model="accordion5">
        <router-link to="/vm">
          <b-card-body class="m-0 p-0">
            <b-card-text class="m-0 p-2">
              <span
                  v-bind:class="[ routePath == '/vm' || routePath == '/conference_notice' ? classObject : '' ]">VM</span>
            </b-card-text>
          </b-card-body>
        </router-link>
      </b-collapse>
    ...
    <b-card no-body class="mb-0 p-0">
      <b-card-header class="p-0" role="tab">
        <b-button block squared v-b-toggle.accordion-6 variant="info" size="sm" class="text-left"
                  v-bind:class="[ routePath == '/biz/site' || routePath == '/biz/schedule' || routePath == '/biz/link' ? active_parent_menu : '' ]">
      ...
      <b-collapse id="accordion-6" visible accordion="inowing-accordion" role="tabpanel" v-model="accordion6">
        <b-card-body class="m-0 p-0">
          ...
          <b-card-text class="m-0 p-2">
                    <span>
                        <a :href="'http://jejueatsuda.com/admin/biz_dashboard.html#/?event_id='+event_id"
                           target="_blank">현황판</a>
                    </span>
          </b-card-text>
    ...
    <b-card no-body class="mb-0 p-0">
      <b-card-header class="p-0" role="tab">
        <b-button block squared v-b-toggle.accordion-7 variant="info" size="sm" class="text-left"
                  v-bind:class="[ routePath == '/stats_login' || routePath == '/site_hit' || routePath == '/stats_counsel_b' || routePath == '/stats_counsel_s' || routePath == '/stats_vm_b' || routePath == '/stats_vm_s' || routePath == '/stats_vm_s_detail' || routePath == '/stats_login_detail' ? active_parent_menu : '' ]">
          <span>7. 통계</span>
        </b-button>
      </b-card-header>
      <b-collapse id="accordion-7" visible accordion="inowing-accordion" role="tabpanel" v-model="accordion7">
        <b-card-body class="m-0 p-0">
          <router-link to="/site_hit">
            <b-card-text class="m-0 p-2">
              <span
                  v-bind:class="[ routePath == '/site_hit'  ? classObject : '' ]">사이트 방문수 </span>
            </b-card-text>
          </router-link>
          ...
          <router-link to="/stats_login">
            <b-card-text class="m-0 p-2">
              <span
                  v-bind:class="[ routePath == '/stats_login' || routePath == '/stats_login_detail' ? classObject : '' ]">로그인(기업)</span>
            </b-card-text>
          </router-link>

          <b-card no-body class="mb-0 p-0">
            <b-card-header class="p-0" role="tab">
              <b-button block squared v-b-toggle.accordion-8 variant="warning" size="sm" class="text-left"
                        v-bind:class="[ routePath == '/stats_counsel_b' || routePath == '/stats_counsel_s' || routePath == '/stats_counsel_b_detail' ? active_parent_menu : '' ]">
                <span>비지니스 상담 예약</span>
              </b-button>
            </b-card-header>
            <b-collapse id="accordion-8" visible accordion="inowing-accordion2" role="tabpanel" v-model="accordion8">
              <b-card-body class="m-0 p-0">
                <router-link to="/stats_counsel_b">
                  <b-card-text class="m-0 p-2">
                    <span
                        v-bind:class="[ routePath == '/stats_counsel_b' || routePath == '/stats_counsel_b_detail' ? classObject : '' ]">바이어</span>
                  </b-card-text>
                </router-link>
                <hr class="m-0 p-0"/>
                <router-link to="/stats_counsel_s">
                  <b-card-text class="m-0 p-2">
                    <span
                        v-bind:class="[ routePath == '/stats_counsel_s'  || routePath == '/stats_counsel_s_detail' ? classObject : '' ]">셀러</span>
                  </b-card-text>
                </router-link>
              </b-card-body>
            </b-collapse>
          ...
          <b-card no-body class="mb-0 p-0">
            <b-card-header class="p-0" role="tab">
              <b-button block squared v-b-toggle.accordion-9 variant="warning" size="sm" class="text-left"
                        v-bind:class="[ routePath == '/stats_vm_b'  ||  routePath == '/stats_vm_b_detail'  || routePath == '/stats_vm_s' ? active_parent_menu : '' ]">
                <span>비지니스 실적 </span>
              </b-button>
            </b-card-header>
            <b-collapse id="accordion-9" visible accordion="inowing-accordion3" role="tabpanel" v-model="accordion9">
              <b-card-body class="m-0 p-0">
                <router-link to="/stats_vm_b">
                  <b-card-text class="m-0 p-2">
                    <span
                        v-bind:class="[ routePath == '/stats_vm_b'  ||  routePath == '/stats_vm_b_detail'  ? classObject : '' ]">바이어</span>
                  </b-card-text>
                </router-link>
                <hr class="m-0 p-0"/>
                <router-link to="/stats_vm_s">
                  <b-card-text class="m-0 p-2">
                    <span
                        v-bind:class="[ routePath == '/stats_vm_s' || routePath == '/stats_vm_s_detail' ? classObject : '' ]">셀러</span>
                  </b-card-text>
                </router-link>
              </b-card-body>
            </b-collapse>
      ...
      <b-button class="mt-1" variant="outline-success"
                v-show="$store.getters.user_level == 0 && $store.getters.event_id == 106"
                @click='goReload(`${window.location.origin}/admin/vue_main.html#/?event_id=105`)'>테스트버전(105) 가기
      </b-button>
      <b-button class="mt-1" variant="outline-primary"
                v-show="$store.getters.user_level == 0 && $store.getters.event_id == 105"
                @click='goReload(`${window.location.origin}/admin/vue_main.html#/?event_id=106`)'>운영버전(106) 가기
      </b-button>
    </b-card>
...
module.exports = {
  ...
  watch: {
    $route: async function (to, from) {
      ...
      let aco7 = ['/stats_login','/site_hit', '/stats_counsel_b', '/stats_counsel_s', '/stats_counsel_b_detail', '/stats_counsel_s_detail', '/stats_vm_b', '/stats_vm_b_detail', '/stats_vm_s', '/stats_vm_s_detail', '/stats_login_detail'];
      let aco8 = ['/stats_counsel_b', '/stats_counsel_b_detail', '/stats_counsel_s_detail', '/stats_counsel_s'];
      let aco9 = ['/stats_vm_b', '/stats_vm_b_detail', '/stats_vm_s', '/stats_vm_s_detail'];
